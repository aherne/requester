...
| execute           | int $maxRedirectionsAllowed = 0,<br/>int $timeout = 300000                                                   | [Lucinda\URL\Response](https://github.com/aherne/requester/blob/master/src/Response.php) | Executes request and produces a response.<br/><small>Throws [Lucinda\URL\RequestException](https://github.com/aherne/requester/blob/master/src/RequestException.php) if invalid request options combination was found.<br/>Throws [Lucinda\URL\ResponseException](https://github.com/aherne/requester/blob/master/src/ResponseException.php) if response retrieval failed (eg: response exceeded timeout).</small> |
...
| execute | int $maxRedirectionsAllowed = 0,<br/>int $timeout = 300000                                                                | [Lucinda\URL\Response](https://github.com/aherne/requester/blob/master/src/Response.php) | Uploads file, updating response status accordingly. |
...
| execute | int $maxRedirectionsAllowed = 0,<br/>int $timeout = 300000                                                                | [Lucinda\URL\Response](https://github.com/aherne/requester/blob/master/src/Response.php) | Downloads file, updating response status accordingly. |
